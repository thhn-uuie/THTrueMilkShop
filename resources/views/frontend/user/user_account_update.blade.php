                ...
                <div class="block account-nav">
                  ...
                  <div class="content account-nav-content">
                    <ul class="nav items">
                      ...
                      <li class="nav item">
                        <a href="https://www.thtruemart.vn/sales/order/history/">Quản lý đơn hàng</a>
                      </li>
                      <li class="nav item">
                    ...
                    <div class="account-form form-wrap">
                        <div class="row mb-4">
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                              <label>Họ tên</label>
                              <div class="data"><input type="text" name="name"></div>
                          </div>
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                              <label>Số điện thoại</label>
                              <div class="data"><input type="tel" name="tel"></div>
                          </div>
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                              <label>Email</label>
                              <div class="data"><input type="email" name="email"></div>
                          </div>
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                          ...
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                              <label>Số CMND</label>
                              <div class="data"><input type="text" name="cmnd"></div>
                          </div>
                          <div class="form-group col-12 col-sm-6 col-lg-6">
                              <label>Địa chỉ</label>
                              <div class="data"><input type="text" name="address"></div>
                          </div>
                        </div>
                        <div class="btn-edit">
                          <a class="action edit" href="https://www.thtruemart.vn/customer/account/edit/">
